        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <motion.div initial="hidden" animate="show" variants={{ hidden: {}, show: { transition: { staggerChildren: 0.1 } } }} className="md:col-span-1 space-y-4">
            {[
              ...
              { icon: Mail, title: 'Email Us', desc: 'ashwinkumarc30@gmail.com' },
            ...
            <div className="bg-white rounded-3xl border border-border shadow-soft p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <Input label="Last Name" name="lastName" value={form.lastName} onChange={updateField} />
                </div>
                <Input label="Email Address" name="email" type="email" value={form.email} onChange={updateField} required />
                
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-semibold text-text">Subject</label>
                  <select name="subject" value={form.subject} onChange={updateField} className="w-full rounded-xl border border-border bg-white px-4 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/10">
